            ...
            <div class="px-6 py-6 bg-indigo-700 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
                ...
                <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
                    <form method="POST" action="{{ route('newsletter') }}" class="sm:flex" novalidate>
                        ...
                        <input id="email" value="{{ old('email') }}" name="email" type="email" class="w-full border-white px-5 py-3 placeholder-gray-500 focus:ring-offset-indigo-700 focus:ring-white focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-md" placeholder="Entrez votre adresse e-mail">
